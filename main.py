...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--driver", help="name of driver", type=str, choices=["metex14"], default="brymen86")
    ...
    if args.driver == "metex14":
        driver = driver_serial_metex_14_byte.DriverSerialMetex14Byte(on_acquisition, 0, device=args.device,
